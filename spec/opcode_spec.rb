...
RSpec.describe Day2 do
  ...
  describe '#self.test' do
    it 'adds puts string to screen' do
      expect(Day2.test).to eql("hey-yo! This is day 2 ya'll")
    end
  end
  ...
  describe '#self.awesome_array' do
    it 'adds puts to screen' do
      expect(Day2.awesome_array([1,0,34,0,99])).to eql(34)
    end
  end
